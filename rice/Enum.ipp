...
each()
{
  VALUE enums_v = Rice::self().iv_get("enums");
...
to_s()
{
  ...
  Rice::Data_Object<Enum_T> m(Rice::self(), klass);
...
eql(Object rhs)
{
  ...
  bool is_equal = from_ruby<int>(compare(rhs)) == 0; 
